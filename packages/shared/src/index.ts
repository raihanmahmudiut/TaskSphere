...
export const todoAppCollaborators = todoAppCollaboratorsSchema.todoAppCollaborators;
...
export type TaskStatus = enumsSchema.TaskStatus;
export type TaskPriority = enumsSchema.TaskPriority;
export type CollaboratorRole = enumsSchema.CollaboratorRole;
