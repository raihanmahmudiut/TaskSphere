...
import type { ColumnType, Filter, FilterOperator } from '@/common/types';
...
export function getFilterOperators(columnType: ColumnType) {
    ...
    > = {
        text: datableConfig.textOperators,
        number: datableConfig.numericOperators,
        select: datableConfig.selectOperators,
        'multi-select': datableConfig.selectOperators,
        boolean: datableConfig.booleanOperators,
        date: datableConfig.dateOperators,
    };

    return operatorMap[columnType] ?? datableConfig.textOperators;
}
