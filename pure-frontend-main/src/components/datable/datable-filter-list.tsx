...
} from '@/components/faceted-filter';
import {
  Sortable,
  SortableDragHandle,
  SortableItem,
...
import { getDefaultFilterOperator, getFilterOperators } from '@/lib/datable';
import { getFiltersStateParser } from '@/lib/parsers';
import { cn, formatDate } from '@/lib/utils';

interface DatableFilterListProps<TData> {
  table: Table<TData>;
...
export function DatableFilterList<TData>({
  table,
  filterFields,
  debounceMs,
  shallow,
}: DatableFilterListProps<TData>) {
  ...
  function addFilter() {
    ...
    void setFilters([
      ...filters,
      {
        id: filterField.id as Extract<keyof TData, string>,
        value: '',
                    ...
                    <div className="min-w-[4.5rem] text-center">
                      {index === 0 ? (
                        ...
                        >
                          ...
                          >
                            {datableConfig.joinOperators.map((op) => (
